...
export const metadata: Metadata = {
  metadataBase: new URL("https://saitechlabs.in"),
  ...
  openGraph: { title: "SaiTech Labs | Industry-Focused IT Training", description: "Practical technology learning for students, graduates and early-career professionals.", url: "https://saitechlabs.in", siteName: "SaiTech Labs", type: "website", locale: "en_IN", images: [{ url: "/og.png", width: 1200, height: 630, alt: "SaiTech Labs — Your launchpad to a top-tier IT career" }] },
...
export default function RootLayout({ children }: Readonly<{ children: React.ReactNode }>) {
  return <html lang="en"><body className={`${bodyFont.variable} ${displayFont.variable}`}><a className="skip-link" href="#main-content">Skip to content</a><Header /><main id="main-content">{children}</main><Footer /><WhatsAppButton /></body></html>;
}
