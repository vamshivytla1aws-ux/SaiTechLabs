...
export const metadata: Metadata = { title: "Courses", description: "Explore training in Cloud, AI, DevOps, Databricks, data, communication and interview preparation.", alternates: { canonical: "/courses" } };
