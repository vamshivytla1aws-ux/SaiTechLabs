...
import {
  ArrowRight, BadgeCheck, BrainCircuit, BriefcaseBusiness, Cloud, CodeXml,
  Database, GitBranch, GraduationCap, MessageSquareText, Mic2, PhoneCall,
  Rocket, Sparkles, Target, UserRoundCheck,
} from "lucide-react";
...
const values = [
  { value: "60", suffix: "Days", label: "Intensive Program" },
  { value: "Industry", suffix: "Experts", label: "Experienced Trainers" },
  { value: "Hands-On", suffix: "Learning", label: "Practical Approach" },
  { value: "Career", suffix: "Ready", label: "Interview Preparation" },
];

const features = [
  [BriefcaseBusiness, "Industry Experts as Trainers"],
  [CodeXml, "Real-Time Projects & Case Studies"],
  [Rocket, "Hands-On Practical Learning"],
  [Target, "Interview Preparation"],
  [UserRoundCheck, "Resume Building Guidance"],
  [Mic2, "Soft Skills & Corporate Training"],
  [GraduationCap, "Career Readiness Focus"],
...
export default function Home() {
  return <>
    <section id="home" data-nav-section="home" className="home-hero">
      ...
      <div className="container hero-layout">
        <div className="hero-content">
          <div className="program-badge"><Sparkles /> Intensive 60-Day Program</div>
          <p className="hero-kicker">Innovate <span>•</span> Educate <span>•</span> Accelerate</p>
          <h1>Your launchpad to<br /><em>a top-tier IT career</em></h1>
          <p className="hero-lead">Learn from industry professionals, build practical technology skills, and prepare yourself for real-world IT careers.</p>
          <p className="audience-line"><GraduationCap />Designed for B.Tech 3rd Year, Final Year & Recent Graduates</p>
          <div className="hero-actions"><Link className="button button-primary" href="/program">Explore program <ArrowRight /></Link><Link className="button button-outline" href="/admissions">Enroll now</Link></div>
          <a className="counselor-link" href="tel:+919493969696"><span><PhoneCall /></span><span><small>Talk to a Counselor</small><strong>+91 94939 69696</strong></span></a>
        </div>
        <div className="hero-visual" aria-label="Technology learning pathways">
          <div className="tech-core"><span>STL</span><strong>Career<br />Launchpad</strong></div>
          <div className="orbit orbit-a"><span><Cloud />Cloud</span><span><BrainCircuit />AI & ML</span></div>
          <div className="orbit orbit-b"><span><GitBranch />DevOps</span><span><Database />Data</span></div>
          <div className="code-panel"><span>LEARN</span><span>PRACTICE</span><span>BUILD</span></div>
        </div>
      </div>
    </section>
    ...
    <section className="section promotions-section"><div className="container promotions-panel"><div><p className="eyebrow">Admissions & Announcements</p><h2>Latest from SaiTech Labs</h2><p>Program announcements and upcoming admission updates will appear here as official promotional material becomes available.</p><Link href="/admissions" className="text-button">View admissions <ArrowRight /></Link></div><div className="promo-placeholders"><div><MessageSquareText /><span>New announcements<br />coming soon</span></div><div><Sparkles /><span>Promotion asset<br />ready</span></div></div></div></section>
    <CTASection id="contact" navSection />
  </>;
}
