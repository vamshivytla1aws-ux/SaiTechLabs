...
export function AdmissionForm() {
  ...
  return <form className="premium-form" onSubmit={submit}>
    ...
    <div className="form-grid">
      ...
      <label>Aadhaar Card Number<input inputMode="numeric" pattern="[0-9]{12}" maxLength={12} autoComplete="off" value={data.aadhaarNumber} onChange={e => update("aadhaarNumber", e.target.value.replace(/\D/g, "").slice(0, 12))} placeholder="12-digit Aadhaar number" /></label>
