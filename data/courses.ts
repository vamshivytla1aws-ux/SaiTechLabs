...
export const courses: Course[] = [
  ...
  { slug: "interviews", title: "Interview Preparation", shortTitle: "Interview Preparation", description: "Practice technical communication, structured problem-solving and real interview scenarios.", topics: ["Technical interviews", "Mock interviews", "Case studies", "Real-world scenarios"], audience: "Job-seeking students and graduates", icon: CodeXml },
];
